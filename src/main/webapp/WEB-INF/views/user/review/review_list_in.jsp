    ...
    <table class="table">
                ...
                <div class="photo_img">
							<span onclick="pusPhotoDetailLayer('6241824');"
                                  style="cursor: pointer;"><img
                                    src="//image2.compuzone.co.kr/img/postscript_order/ProductForUsed_4/896343/1624049_1.jpg"
                                    alt=""></span>
                </div>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="align_l title"><a style="cursor: pointer;"
                ...
                <p>
                    듬직하니 좋습니다~!!!! 발열은 진짜 걱정 없을듯 하네요~ 감사합니다~!!! <em class="photo"></em>
                </p>
            </a></td>
            <td>jjag****</td>
            <td>2022-10-27</td>
