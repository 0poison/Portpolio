...
<nav
    ...
    <div class="collapse navbar-collapse" id="navMenu">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="${root }admin/client">회원 목록</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="${root }admin/product">상품 관리</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="${root }admin/support">문의 내역</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="${root }admin/order">주문 내역</a>
            </li>
        </ul>
